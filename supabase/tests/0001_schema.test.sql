...
select has_column('public', 'businesses', 'booking_notes', 'businesses.booking_notes exists (§12.53)');
select col_is_null('public', 'businesses', 'booking_notes', 'booking_notes is nullable — a business need not state one');
