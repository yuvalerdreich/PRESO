...
const employees = [
  { id: 'zohar', name: { he: 'זוהר לוי', en: 'Zohar Levi' }, position: { he: 'מעצבת שיער', en: 'Hair stylist' }, contactLabel: '03-6001122', status: 'active' },
  { id: 'noa', name: { he: 'נועה גולן', en: 'Noa Golan' }, position: { he: 'צבע וטיפולי שיער', en: 'Colour and hair care' }, contactLabel: '052-3334455', status: 'active' },
] as const;
const appointments = [
  ...
  { id: 'dashboard-2', dateKey: '2026-08-18', clientName: { he: 'נועה גולן', en: 'Noa Golan' }, clientContact: '052-3334455', employeeId: 'noa', employeeName: employees[1].name, serviceName: { he: 'גוונים וצבע אומברה', en: 'Highlights and ombré colour' }, time: '11:00 – 12:30', status: 'pending' },
