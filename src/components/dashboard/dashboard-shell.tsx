...
export function DashboardShell({ business, active, children }: { business: DashboardBusiness; active: 'overview' | 'appointments' | 'services' | 'staff'; children: ReactNode }) {
  const { locale, copy } = useLanguage();
  const nav = [{ id: 'overview' as const, href: '/dashboard', label: copy.dashboard.overview, Icon: Building2 }, { id: 'appointments' as const, href: '/dashboard/appointments', label: copy.dashboard.appointments, Icon: CalendarDays }, { id: 'services' as const, href: '/dashboard/services', label: copy.dashboard.services, Icon: Wrench }, { id: 'staff' as const, href: '/dashboard/staff', label: copy.dashboard.staff, Icon: UsersRound }];
